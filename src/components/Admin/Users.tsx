    ...
    return (  
        <div className="px-4 py-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                <h1 className="text-2xl md:text-3xl font-extrabold">User Management</h1>
                    ...
                    <tbody>
                        {
                            users.map((user) => (
                                <tr key={user.id} className="border-t border-white/10">
                                    ...
                                    <td className="py-3 pr-4">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-bold ${user.status === "active" ? "bg-emerald-400/80" : "bg-rose-400/80"} text-[#272727] dark:text-white/90`}>
                                            {user.status}
                                        </span>
                                    </td>
                                    <td className="py-3">
