                ...
                <div className="flex flex-col gap-4 order-2 lg:order-1">
                    <div className="p-5 rounded-2xl bg-white/45 dark:bg-black/35 border border-white/35 dark:border-white/10 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
                        ...
                        <div className="mt-4 flex flex-wrap gap-3">
                            <Button className="bg-[#D4AA7D] hover:bg-[#EFD09E] text-black">Start Game</Button>
                            <Button className="bg-[#D4AA7D] hover:bg-[#EFD09E] text-black">Pause</Button>
                            <Button className="bg-transparent border-2 border-[#D4AA7D] text-[#D4AA7D] hover:bg-[#D4AA7D] hover:text-black">End Game</Button>
                        </div>  
                    </div>
                    <div className="p-5 rounded-2xl bg-white/45 dark:bg-black/35 border border-white/35 dark:border-white/10 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
                    ...
                    <div className="p-5 flex flex-wrap items-center justify-between gap-3 bg-white/45 dark:bg-black/35 backdrop-blur-md rounded-2xl border border-white/35 dark:border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2 rounded-xl px-3 py-2 bg-black/5 dark:bg-white/5">
                                <span className="text-xs uppercase tracking-wider opacity-80">Board</span>
                                <button
                                    className="text-sm font-semibold px-2 py-1 rounded-lg transition bg-[#D4AA7D] text-black">
                                    6x6
                                </button>
                                <button
                                    className="text-sm font-semibold px-2 py-1 rounded-lg transition bg-transparent hover:bg-white/10">
                                    8x8
                                </button>
                            </div>
