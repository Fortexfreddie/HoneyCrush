    ...
    return (
        <header className="container mx-auto px-4 pt-5">
            ...
            <div className="grid place-items-center">
                <Button onClick={() => setSidebarOpen(!sidebarOpen)} className={`xl:hidden mr-2 transform transition-transform duration-300 ${ sidebarOpen ? "scale-x-[-1]" : "scale-x-[1]" }`}>{ !sidebarOpen ? <Menu className="h-6 w-6" /> : <X className="h-6 w-6" />}</Button>
            </div>
