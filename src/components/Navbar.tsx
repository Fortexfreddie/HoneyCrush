...
const Navbar = () => {
    ...
    return (
      <header className="container mx-auto px-4 pt-5">
        <div className="flex items-center justify-between p-4 rounded-[16px] bg-white/35 dark:bg-black/28 border border-white/30 dark:border-white/12 backdrop-blur-[10px] shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
